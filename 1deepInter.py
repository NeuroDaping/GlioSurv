...
df_test = pd.read_csv("D:\\ChongQwork\\F63GBMlipid\\S2cliMo\\GBM\\intestSet.csv", index_col=0)
...
print("\n各模型风险分数（前5行）：")
print(risk_df.head())
risk_df.to_csv("interRisk.csv", index=True)
# ==================================================
import joblib
